...
export default function Portfolio() {
  return (
    <section id="portfolio" className="relative mt-24">
      <WavySeparator fill="#ffffff" variant={2} />
      <div className="section-padding bg-gradient-to-b from-white to-purple-50">
